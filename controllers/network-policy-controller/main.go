...
func main() {
	...
	externalObjInformerFactory := extinformers.NewSharedInformerFactory(exampleClient, time.Second*30)

	controller := NewNpcController(kubeClient, exampleClient, kubeInformerFactory, externalObjInformerFactory)
