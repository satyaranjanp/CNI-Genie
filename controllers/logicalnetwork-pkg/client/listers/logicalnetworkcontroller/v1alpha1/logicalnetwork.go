...
import (
	"controller/k8s.io/apimachinery/pkg/api/errors"
//	"controller/k8s.io/apimachinery/pkg/labels"
...
func (s logicalNetworkNamespaceLister) Get(name string) (*v1alpha1.LogicalNetwork, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("logicalnetwork"), name)
	}
